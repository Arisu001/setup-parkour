...
summon block_display ~ ~2.4 ~-4 {Tags: ["sw", "stg", "blk_str"], block_state: {Name: "emerald_block"}}
summon block_display ~ ~2.4 ~3 {Tags: ["sw", "stg", "blk_endg"], block_state: {Name: "gold_block"}}
summon block_display ~-.5 ~3 ~-.5 {Tags: ["sw", "stg", "blk_ckpt"], block_state: {Name: "lever", Properties: {face: "wall", facing: "west", powered: "true"}}}

summon interaction ~.35 ~4 ~-3.47 {Tags: ["sw", "stg", "int_mode_0"]}
summon interaction ~.35 ~3.5 ~-3.47 {Tags: ["sw", "stg", "int_mode_1"]}
summon interaction ~ ~3.63 ~-2.27 {Tags: ["sw", "stg", "int_add_xpc"]}
summon interaction ~ ~2.93 ~-2.27 {Tags: ["sw", "stg", "int_rmv_xpc"]}
summon interaction ~.5 ~4 ~.02 {Tags: ["sw", "stg", "int_time_0"]}
summon interaction ~.85 ~3.6 ~ {Tags: ["sw", "stg", "int_time_1"]}
summon interaction ~.9 ~3.2 ~ {Tags: ["sw", "stg", "int_time_2"]}
summon interaction ~1 ~2.8 ~ {Tags: ["sw", "stg", "int_no_time"]}
summon interaction ~.4 ~4 ~3.51 {Tags: ["sw", "stg", "int_rkg_0"]}
...
summon interaction ~1.35 ~.75 ~-3.5 {Tags: ["sw", "stg", "int_prev_page"]}
