...
summon block_display ~-.5 ~3 ~-.5 {Tags: ["sw", "stg", "blk_ckpt"], block_state: {Name: "lever", Properties: {face: "wall", facing: "north", powered: "true"}}}
...
summon interaction ~-3.51 ~3.2 ~.5 {Tags: ["sw", "stg", "int_rkg_2"]}
