...
data merge entity @e[tag=rkg_2, limit=1] {Tags: ["sw", "stg", "sel_rkg", "rkg_2"], text: '[{"text": ">> ", "color": "aqua"}, {"text": "Top 1O ", "color": "#19df5"}, {"text": "<<", "color": "aqua"}]'}
...
data merge entity @e[tag=sel_rkgs, limit=1] {Tags: ["sw", "stg", "sel_rkgs"], text: '[{"text": "Choisi", "color": "#ff8d00"}, {"text": ": ", "color": "yellow"}, {"text": "Top 10 ", "color": "#19df5"}]'}
