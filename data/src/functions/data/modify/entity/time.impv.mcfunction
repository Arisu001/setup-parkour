...
data merge entity @e[tag=time_1, limit=1] {Tags: ["sw", "stg", "sel_time", "time_1"], text: '[{"text": ">> ", "color": "aqua"}, {"text": "00", "color": "gray"}, {"text": ":", "color": "white"}, {"text": "00", "color": "gray"}, {"text": ":", "color": "white"}, {"text": "00", "color": "gray"}, {"text": ".", "color": "white"}, {"text": "00 ", "color": "gold"}, {"text": "<<", "color": "aqua"}]'}
...
data merge entity @e[tag=sel_times, limit=1] {Tags: ["sw", "stg", "sel_times"], text: '[{"text": "Choisi", "color": "#ff8d00"}, {"text": ": ", "color": "yellow"}, {"text": "00", "color": "gray"}, {"text": ":", "color": "white"}, {"text": "00", "color": "gray"}, {"text": ":", "color": "white"}, {"text": "00", "color": "gray"}, {"text": ".", "color": "white"}, {"text": "00", "color": "gold"}]'}
